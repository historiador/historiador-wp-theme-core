...
<article id="panel<?php echo $historiadorcounter; ?>" <?php post_class( 'historiador-panel ' ); ?> >

	<?php
	if ( has_post_thumbnail() ) :
		$thumbnail = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), 'historiador-featured-image' );
